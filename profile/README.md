...
| 🧠 **Selenium Boot MCP JetBrains Plugin** | Registers the MCP server with the JetBrains AI Assistant across IntelliJ IDEA, PyCharm & more | [JetBrains Marketplace](https://plugins.jetbrains.com/plugin/32516) |
